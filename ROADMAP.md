...
- [x] **Rate limiting on failed verifications:** Add protection to prevent bots from spamming invalid signatures, which could cause excessive RPC calls to Solana or Base nodes.
...
- [x] **Version management:** Establish a process for version bumping and publishing to npm.
- [x] **Automated CI/CD:** Add GitHub Actions to automatically run unit tests and type checks on every push or pull request.
